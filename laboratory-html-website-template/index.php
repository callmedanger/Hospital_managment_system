                    ...
                    <div class="ms-auto d-none d-lg-flex">
                        ...
                        <div class="dropdown ms-2">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="loginDropdown">
                                <li><a class="dropdown-item" href="../hospital/hms/user-login.php">Patient Login</a></li>
                                <li><a class="dropdown-item" href="../hospital/hms/admin/index.php">Admin Login</a></li>
                                <li><a class="dropdown-item" href="../hospital/hms/doctor/index.php">Doctor Login</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 text-center text-md-end">
                    ...
                    <p class="mb-0">Designed by <a href="https://phpcodex.com">php Codex</a></p>
                </div>
            </div>
        </div>
    </div>
