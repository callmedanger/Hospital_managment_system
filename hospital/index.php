    ...
    <!-- ################# Header Starts Here#######################--->
      ...
      <header id="menu-jk">
        ...
        <div id="nav-head" class="header-nav">
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-3  col-sm-12 d-flex align-items-center justify-content-center" style="height:100%; min-height:60px; margin-top: 1% !important;">
                        <span style="font-size:24px; font-weight:600; color:#333; letter-spacing:1px;">Nexa Health</span>
            ...
            <div class="carousel-inner">
                <div class="carousel-item ">
                    ...
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown">Next Health</h5>
