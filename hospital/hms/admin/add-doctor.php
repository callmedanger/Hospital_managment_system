...
$sql=mysqli_query($con,"insert into doctors(specilization,doctorName,address,docFees,contactno,docEmail,password,photo) values('$docspecialization','$docname','$docaddress','$docfees','$doccontactno','$docemail','$password','$photoPath')");
if($sql)
{
...
<div class="form-group">
    <label for="photo">Doctor Picture (Clear Face Image)</label>
